...
<body>
    ...
    <div class="container">
        <input type="hidden" id="ratee" value="<?= echo $ratee?>"/>
        <input type="hidden" id="rater" value="<?= echo $rater?>"/>
    ...
    <script>
        ...
        function submitRating() {
            ...
            fetch('ratingAction.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                body: `submitRating=true&partnerID=${partner}&rating=${rating}`
            })
            ...
            function submitReport() {
                ...
                fetch('../action/ratingAction.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                    body: `submitReport=true&partnerID=${partner}&reason=${reason}`
                })
                .then(response => response.text())
                .then(text => alert(text))
                .catch(error => console.error('Error:', error));
