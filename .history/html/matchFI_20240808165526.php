    ...
    potentialSupports.forEach(support => {
        ...
        resultDiv.innerHTML = `
            ...
            <div>
                ...
                ">Rate this FI</a><br>
                <a href="chat.php?buddy=${support.name}&buddyid=${support.userID}">Chat with <strong>FI</strong></a><br>
                <a href="conference.php?buddy=${support.name}&buddyid=${support.userID}">Call <strong>FI</strong></a>
            </div>
        `;
