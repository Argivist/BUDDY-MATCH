        ...
        function displayResults(potentialSupports) {
            ...
            potentialSupports.forEach(support => {
                ...
                resultDiv.innerHTML = `<strong>Name:</strong> ${support.name}<br>
                                       ...
                                       <?php
                                       session_start();
                                       echo "<a href='rating.php?buddy='+support.userID+'>Rate this Buddy</a>";
                                        echo "<a href='chat.php?buddy='+support.userID+'&buddyid=" . htmlspecialchars($_SESSION['userID']) . "'>Chat with <strong>Buddy</strong></a>";
