        ...
        function displayResults(potentialSupports) {
            ...
            potentialSupports.forEach(support => {
                ...
                resultDiv.innerHTML = `<strong>Name:</strong> ${support.name}<br>
                                       ...
                                       <div>
                                       <a href="rating.php?ratee=${support.userID}&rater=<?php session_start(); echo $_SESSION['userID'] ?>">Rate</a>
                                      
                                        <a href="chat.php?buddyid=${support.userID}">Chat</a>
                                       <a href="video.php?userID=${support.userID}">Video</a>
                                       </div>
                                       `;
                                    //    buttons
