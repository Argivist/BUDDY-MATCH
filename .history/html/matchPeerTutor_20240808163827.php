            ...
            potentialSupports.forEach(support => {
                ...
                resultDiv.innerHTML = `<strong>Name:</strong> ${support.name}<br>
                                       ...
                                       echo "<a href=`rating.php?buddy='+support.userID+`>Rate this Buddy</a>";
                                        echo "<a href=`chat.php?buddy='+support.name+'&buddyid='support.userID`>Chat with <strong>Buddy</strong></a>";
                                        echo "<a href=`conference.php?buddy=buddy='+support.name+'&buddyid='+support.userID+'`>Call <strong> Buddy</strong></a>";
                                        ?>
                                       </div>
                                       `;
                                    //    buttons
