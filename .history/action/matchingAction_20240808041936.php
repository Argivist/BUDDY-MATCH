...
$users = $stmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    foreach ($potentialStudyBuddies as $buddy) {
        ...
        $scoreList[] = ['name' => $buddy['name'],'uid'=>$buddy['userID'], 'score' => $score, 'major' => $buddy['major'], 'hoursToStudy' => $buddy['studyHabits'], 'stressLevel' => $buddy['stressLevel'], 'interest' => $buddy['interests'], 'date' => $buddy['availableDate']];
        echo $scoreList['name'] . "<br>";
    }
