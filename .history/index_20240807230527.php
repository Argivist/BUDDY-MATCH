				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						if (!isset($_SESSION['userID'])) {
							echo `
							<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="profile.php" id="dropdown-a" data-toggle="dropdown">your profile </a>
							</li> 
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="action/logout.php" id="dropdown-a" data-toggle="dropdown">your profile </a>
							</li>
							`;
						}else{
							//login button
							echo `
							<li class="nav-item dropdown">
								<a class="nav-link dropdown-toggle" href="register.php" id="dropdown-a" data-toggle="dropdown">Login </a>
							</li>								
							`;
						}
						sess
