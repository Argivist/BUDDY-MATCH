				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							...
							?>
							id="dropdown-a" data-toggle="dropdown">Match </a>
							<?php
							if(isset($_SESSION['userID'])){
								echo '
							<div class="dropdown-menu" aria-labelledby="dropdown-a">
								...
								<a class="dropdown-item" href="./html/matchPeerTutor.php">Student Tutors</a>
							 </div>';
							 }?>
						</li>
                        ...
                        if (isset($_SESSION['userID'])) {
                            echo '
                            <li class="nav-item">
                                <a class="nav-link" href="html/viewProfile.php">Your Profile</a>
                            </li> 
                            <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <p>Connecting learners and mentors to foster collaborative study and personal growth. Our platform matches you with the perfect study buddy to enhance your educational journey together.</p>   
